...
目前的最新的版本是 **Py-Apple Dynamics V6.5 请在  Py Apple Dynamics V6.5(最新版)  文件夹中下载，最新开源代码存放于根目录下，可自由下载。**古早版本 文件夹中存放着之前的老版本代码, 包括早期测试用的 Arduino 版本、基于 Stm32 F4的 Pyboard 版本、以及早期外围程序（地面站、红外遥控）等等。
...
12. 航模遥控器控制
13. **空间连杆角度补偿--更精确的运动**
14. 修复 V4.0 WIFI 控制器 web_c.py 出现 ECONNRESET 的 BUG
15. 巡线程序（测试版）
16. 图形化编程（测试版）
17. **VMC 步态算法**
18. **自适应爬楼梯 WALK 步态**